...
const head = {
  backgroundImage: "linear-gradient(to bottom right, #3a244b, #ae256d)",
};
        ...
        <Toolbar>
          ...
          {/* <Link to="/" className="stylea">
                    <Typography className={classes.title} variant="h6" noWrap>
                        <DiDrupal size="35" style={{position: 'relative', top: '7px'}} />   React NodeJS
                    </Typography>
                    </Link> */}
          <Typography className={classes.title} variant="h6" noWrap>
            <DiDrupal size="35" style={{ position: "relative", top: "7px" }} />{" "}
            React Nodejs Crud
          </Typography>
          ...
          <Link to="/" style={{ textDecoration: "none", color: "white" }}>
            <Typography
              ...
              noWrap
            >
              <FcHome size="30" style={{ position: "relative", top: "7px" }} />{" "}
              Home
            </Typography>
          </Link>
          &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
